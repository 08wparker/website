...
Relational CLIF (RCLIF) is a database of clinically useful data on critical illness that is organized into clinically relevant column categories - demographics, objective measures, respiratory support, orders, and inputs-outputs. Below are sample templates for each table in R-CLIF. Here you can find detailed descriptions of each table and their fields.
...
-   ![Experimental](https://img.shields.io/badge/Maturity-Experimental-red) **Experimental**: Majority of critical illness not represented in Entity-Relationship (ER) model, expect frequent breaking changes.
-   ![Beta](https://img.shields.io/badge/Maturity-Beta-yellow) **Beta**: Breaking changes to existing tables or structure unlikely. Actively seeking feedback about new tables to add to the ER model to fully capture critical illness and new fields to add to individual tables.
-   ![Stable](https://img.shields.io/badge/Maturity-Stable-brightgreen) **Stable**: Tested and published in multiple peer reviewed manuscripts and recommended for general use. EHR data not currently represented in CLIF outside the scope of the format.
...
The entity-relationship model for this project is currently at the ![Beta](https://img.shields.io/badge/Maturity-Beta-yellow) **Beta** level for adult patients in a general medical intensive care unit with common conditions such as septic shock and acute respiratory failure. Major breaking changes to the existing structure are unlikely. The consortium is actively seeking feedback about new tables and fields to add to the ER model to achieve the goal of representing developing a [minimum Common ICU Data Elements (mCIDE)](https://clif-consortium.github.io/website/mcide.html) and complete representation of all clinically useful data on critically ill patients.
